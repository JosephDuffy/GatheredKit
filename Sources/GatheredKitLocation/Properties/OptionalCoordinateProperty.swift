...
@propertyWrapper
public final class OptionalCoordinateProperty: UpdatableProperty, PropertiesProvider {
    ...
    public var projectedValue: ReadOnlyProperty<OptionalCoordinateProperty> { asReadOnlyProperty }
    ...
    @OptionalAngleProperty public private(set) var latitude: Measurement<UnitAngle>?

    @OptionalAngleProperty public private(set) var longitude: Measurement<UnitAngle>?
