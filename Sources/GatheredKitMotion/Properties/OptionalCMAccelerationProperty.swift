...
public final class OptionalCMAccelerationProperty: UpdatableProperty, PropertiesProvider {
    ...
    @OptionalAccelerationProperty public private(set) var x: Measurement<UnitAcceleration>?

    @OptionalAccelerationProperty public private(set) var y: Measurement<UnitAcceleration>?

    @OptionalAccelerationProperty public private(set) var z: Measurement<UnitAcceleration>?
