...
@propertyWrapper public final class CMMagneticFieldProperty: UpdatableProperty, PropertiesProvider {
    ...
    @MagneticFieldProperty public private(set) var x: Measurement<UnitMagneticField>

    @MagneticFieldProperty public private(set) var y: Measurement<UnitMagneticField>

    @MagneticFieldProperty public private(set) var z: Measurement<UnitMagneticField>
    ...
    public var projectedValue: ReadOnlyProperty<CMMagneticFieldProperty> { asReadOnlyProperty }
