...
@propertyWrapper public final class CMAccelerationProperty: UpdatableProperty, PropertiesProvider {
    ...
    @AccelerationProperty public private(set) var x: Measurement<UnitAcceleration>

    @AccelerationProperty public private(set) var y: Measurement<UnitAcceleration>

    @AccelerationProperty public private(set) var z: Measurement<UnitAcceleration>
    ...
    public var projectedValue: ReadOnlyProperty<CMAccelerationProperty> { asReadOnlyProperty }
