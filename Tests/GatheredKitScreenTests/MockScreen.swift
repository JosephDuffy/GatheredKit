...
final class MockScreen: UIScreen {
    ...
    override var bounds: CGRect {
        get { return _bounds ?? super.bounds }
    ...
    override var nativeBounds: CGRect {
        get { return _nativeBounds ?? super.nativeBounds }
        set { _nativeBounds = newValue }
    }

    private var _scale: CGFloat?

    override var scale: CGFloat {
        get { return _scale ?? super.scale }
        set { _scale = newValue }
    }
    ...
    override var nativeScale: CGFloat {
        get { return _nativeScale ?? super.nativeScale }
        set { _nativeScale = newValue }
    }
    ...
    override var brightness: CGFloat {
        get { return _brightness ?? super.brightness }
